...
function passiveBehaviorPreviewLabel() {
 ...
 function syncGeneratedContactPresenceReadout(encounter) {
  ...
  function localTelemetryPulseLines(routeId, pathKey, mode) {
    const routeLines = {
      aer: ['SIGNAL VARIANCE: LOW', 'CLOUDLINE ECHO STABLE', 'ALTITUDE CHANNEL HOLDING', 'CLOUDLINE ECHO DRIFT', 'ALTITUDE VARIANCE: LOCAL', 'SKY CHANNEL HOLDING'],
      mare: ['PRESSURE RIPPLE: LOCAL', 'OXYGEN CHANNEL HOLDING', 'CURRENT VECTOR DRIFT', 'PRESSURE INDEX SHIFT', 'CURRENT ECHO LOCAL', 'DEPTH CHANNEL HOLDING'],
      terra: ['DUST INDEX SHIFT', 'GROUND SIGNAL FLICKER', 'RUIN VISIBILITY VARIANCE', 'GROUND ECHO LOCAL', 'RUIN SIGNAL HOLDING']
    };
    const pathLines = {
      DOOMED: ['CHANNEL DRIFT: ELEVATED', 'VOLATILE ECHO PASSING', 'VOLATILE CHANNEL DRIFT', 'PRESSURE ECHO PASSING'],
      MERGED: ['SYNTHETIC CHANNEL CLEAN', 'ECHO ALIGNMENT HOLDING', 'SYNTHETIC ECHO HOLDING', 'DISPLAY CHANNEL CLEAN']
    };
